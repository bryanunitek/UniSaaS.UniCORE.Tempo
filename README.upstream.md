...
Grafana Tempo is distributed under [AGPL-3.0-only](LICENSE). For Apache-2.0 exceptions, see [LICENSING.md](https://git.unitek-systems.com/UniCORE/UniSaaS.UniCORE.Tempo/src/branch/main/LICENSING.md) (mirror: [GitHub](https://github.com/bryanunitek/UniSaaS.UniCORE.Tempo/blob/main/LICENSING.md)).
